...
하지만 취준 기록이 이것저것 섞여있기도 하고 특정 플랫폼에 의존하고 있는게 별로 맘이 편하지 않았다. 
...
![about](/static/images/231105-jekyll-blog/about-tab.png)
...
블로그의 루트 디렉터리에 sitemap.xml 다음처럼 작성해 위치해 준다. 
...
![utterances](/static/images/231105-jekyll-blog/utterances.png)
...
![Favicon](/static/images/231105-jekyll-blog/favicon.png)
